  ...
  <div className="container py-5">
    <div className="row g-5">
      ...
      <div className="col-lg-4 col-md-6">
        ...
        <p className="mb-2"><i className="fa fa-phone-alt me-3"></i>+961 76 993283</p>
        <p className="mb-2"><i className="fa fa-envelope me-3"></i>hadialghoul2003@gmail.com</p>
    ...
    <div className="copyright">
      <div className="row">
        ...
        <div className="col-md-6 text-center text-md-end">
          Designed By <a className="border-bottom text-decoration-none fw-bold text-danger" href="https://htmlcodex.com">Hadi Alghoul</a>
        </div>
      </div>
    </div>
  </div>
